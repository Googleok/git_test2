...
%>
	...
	<div class="logo" style="background-color: powderblue">
		<a href="index.html" class="a_logo"><span>OBF.DEV</span></a>
	</div>
	</header>
	...
	<form action="modify.do" method="post">
		<table width="1300" cellpadding="0" cellspacing="0" border="1"
			...
			<tr>
				...
				<td><input type="text" name="bName"
					value="${content_view.bName}" style="width: 1225px;"></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="bTitle"
					value="${content_view.bTitle}" style="width: 1225px;"></td>
			</tr>


			<tr>
				<td align="center">내용</td>
				<td><textarea rows="20" name="bContent" style="width: 1225px;">${content_view.bContent} </textarea></td>
			</tr>
		...
		<div align="center">
			...
			&nbsp;&nbsp;
			<button type="button"
				onclick="location.href='delete.do?bId=${content_view.bId}' ">삭제</button>
			&nbsp;&nbsp;
			<button type="button"
				onclick="location.href='reply_view.do?bId=${content_view.bId}' ">답변</button>
			&nbsp;&nbsp;
		</div>
		<%
			} else {
